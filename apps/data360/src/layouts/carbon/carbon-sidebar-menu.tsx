              ...
              <Fragment key={'sortable-menu' + item.name + '-' + index}>
                <SortableList.Item id={item.id}>
                  ...
                  >
                        ...
                        <span className="flex items-center">
                          {enabled && (
                            <SortableList.DragHandle
                              className={cn(
                                'inset-t-0 absolute start-1 me-1 size-5 text-gray-900 [&>svg]:size-[20px]',
                    ...
                    <Menu.List className="relative w-[280px] !border-transparent !px-2 !py-3 after:absolute after:-start-5 after:top-0 after:h-full after:w-5 dark:border-gray-300 dark:bg-gray-100">
