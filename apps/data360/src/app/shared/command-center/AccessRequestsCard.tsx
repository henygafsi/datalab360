...
/**
 * AccessRequestsCard — the Access Requests inbox/table, moved from the bottom
 * of the account-overview one-pager into the Security tab (2026-07-10 tabbed
 * redesign). Content is UNCHANGED — only re-disposed; the pending count now
 * also surfaces as a badge on the Security entry of the SectionRail.
 *
