// C:\Users\banno\OneDrive\Bureau\datalab360Front\apps\data360\src\app\shared\gouvernance\roles\filters.tsx
    ...
    <Flex align="center" justify="between" className="mb-4 gap-0">
      <Flex align="center" className="w-auto flex-wrap">
        <Input
          ...
          placeholder="Search by name..." // Changed to "Search by role name..." if applicable
      ...
      <Flex align="center" className="w-auto">
        ...
        <FilterDrawerView
          drawerTitle="Role Filters" // Changed title
          isOpen={openDrawer}
