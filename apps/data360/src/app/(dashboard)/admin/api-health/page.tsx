...
import {
  ...
  recordEvent, getProjectEvents, getEvent, deleteEvent,
  ...
  changeColumnType, addForeignKey, addColumnComment,
  executeEventAction, executePendingEvents,
...
import {
  ...
  getMaskingPolicyDetails, getMaskedColumns, deleteMaskingPolicy,
...
const TEST_MODULES: ModuleDef[] = [
  ...
  // ─── OBSERVABILITY ───
  {
    ...
    tests: [
      ...
      { name: 'getObservabilityDashboard', fn: () => getObservabilityDashboard() },
      ...
      { name: 'getActivityHeatmap', fn: () => getActivityHeatmap() },
      { name: 'getLoginHistory', fn: () => obsLoginHistory() },
      { name: 'getSecurityPosture', fn: () => obsSecurityPosture() },
      { name: 'getSensitiveDataSummary', fn: () => getSensitiveDataSummary() },
      { name: 'getUnusedTables', fn: () => getUnusedTables() },
      { name: 'getDormantUsers', fn: () => getDormantUsers() },
  ...
  // ─── EXPLORE DESIGN ───
  {
    ...
    tests: [
      ...
      { name: 'getEvent', fn: () => getEvent(FAKE_ID, FAKE_ID) },
  ...
  },
  {
    ...
    tests: [
      ...
      { name: 'addColumnComment', fn: () => addColumnComment(FAKE_ID, FAKE_DB, FAKE_SCHEMA, FAKE_TABLE, 'COL', 'test comment') },
  ...
  },
  {
    ...
    tests: [
      ...
      { name: 'updateUser', fn: () => updateUser(FAKE_ID, { comment: 'test' }) },
  ...
  // ─── GOUVERNANCE POLICIES ───
  {
    ...
    tests: [
      ...
      { name: 'getMaskedColumns', fn: () => getMaskedColumns() },
