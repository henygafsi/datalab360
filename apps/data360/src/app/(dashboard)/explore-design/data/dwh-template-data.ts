...
export const DWH_TEMPLATE_TABLES: DwhTemplateTable[] = [
  ...
  // ── DIM_CLIENTS ──
  {
    ...
    columns: [
      { name: 'COD_CLIENT', dataType: 'NUMBER(38,0)', nullable: false, primaryKey: true },
  ...
  // ── DIM_FOURNISSEURS ──
  {
    ...
    columns: [
      { name: 'COD_FOURNISSEUR', dataType: 'NUMBER(38,0)', nullable: false, primaryKey: true },
  ...
  // ── DIM_ITEMS ──
  {
    ...
    columns: [
      { name: 'COD_ARTICLE', dataType: 'NUMBER(38,0)', nullable: false, primaryKey: true },
  ...
  // ── DIM_MAGASINS ──
  {
    ...
    columns: [
      { name: 'COD_MAGASIN', dataType: 'NUMBER(38,0)', nullable: false, primaryKey: true },
  ...
  // ── DIM_VENDEURS ──
  {
    ...
    columns: [
      { name: 'COD_VENDEUR', dataType: 'NUMBER(38,0)', nullable: false, primaryKey: true },
      { name: 'LIB_VENDEUR', dataType: 'VARCHAR(256)', nullable: true, primaryKey: false },
      { name: 'COD_MAGASIN', dataType: 'NUMBER(38,0)', nullable: true, primaryKey: false },
  ...
  // ── FACT_ORDERS ──
  {
    ...
    columns: [
      ...
      { name: 'COD_FOURNISSEUR', dataType: 'NUMBER(38,0)', nullable: true, primaryKey: false },
  ...
  // ── FACT_TRANSACTIONS ──
  {
    ...
    columns: [
      ...
      { name: 'COD_VENDEUR', dataType: 'NUMBER(38,0)', nullable: true, primaryKey: false },
      { name: 'COD_CLIENT', dataType: 'NUMBER(38,0)', nullable: true, primaryKey: false },
      { name: 'COD_ARTICLE', dataType: 'NUMBER(38,0)', nullable: true, primaryKey: false },
