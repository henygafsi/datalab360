import {
  ...
  // New block icons
  BarChart,
  // Icons for newly catalogued blocks (compute_pool, container_service, git_file, ai_embed, ai_redact, ai_parse_document, ai_transcribe, ml_anomaly, copy_into, normalize_col)
  FileCode2,
  Server,
  Box,
  Sigma,
...
export const ETL_BLOCKS: ETLBlockDefinition[] = [
  ...
  // ============================================
  // ADDITIONAL SOURCE BLOCKS (catalog coherence pass)
  // ============================================
  {
    id: 'git_file',
    type: 'git_file',
    label: 'Git File',
    description: 'Load file from a Git repository',
    icon: FileCode2,
    category: 'source',
    color: 'text-zinc-600',
    ...
    minInputs: 0,
    maxInputs: 0,
    tooltip: 'Read a file (SQL, Python, config) from a Git repository branch and use its content downstream',
  },
  {
    id: 'iceberg_source',
    type: 'iceberg_source',
    label: 'Iceberg Source',
    description: 'Read from an Apache Iceberg table',
    icon: Database,
    category: 'source',
    color: 'text-sky-600',
    bgColor: 'bg-sky-50 dark:bg-sky-900/20',
  ...
  // ============================================
  // ADDITIONAL TRANSFORM BLOCKS (catalog coherence pass)
  // ============================================
  {
    id: 'merge',
    type: 'merge',
    label: 'Merge',
    description: 'MERGE INTO target with match/not-match clauses',
    icon: GitMerge,
    category: 'transform',
    color: 'text-emerald-600',
    bgColor: 'bg-emerald-50 dark:bg-emerald-900/20',
    ...
    minInputs: 2,
    maxInputs: 2,
    tooltip: 'Upsert source into target using MERGE INTO with configurable when-matched / when-not-matched actions',
  },
  {
    id: 'set_col_value',
    type: 'set_col_value',
    label: 'Set Column Value',
    description: 'Assign a fixed or expression value to a column',
    icon: Edit3,
    category: 'transform',
    color: 'text-teal-600',
    bgColor: 'bg-teal-50 dark:bg-teal-900/20',
    ...
    minInputs: 1,
    maxInputs: 1,
    tooltip: 'Set or overwrite a column with a constant value or SQL expression',
  },
  {
    id: 'normalize_col',
    type: 'normalize_col',
    label: 'Normalize Column',
    description: 'Min-max or z-score normalization on a column',
    icon: Sliders,
    category: 'transform',
    color: 'text-indigo-600',
    bgColor: 'bg-indigo-50 dark:bg-indigo-900/20',
    ...
    minInputs: 1,
    maxInputs: 1,
    tooltip: 'Normalize numeric column values using min-max scaling or z-score standardization',
  },

  // ============================================
  // ADDITIONAL ADVANCED TRANSFORM BLOCKS (catalog coherence pass)
  // ============================================
  {
    id: 'flatten',
    type: 'flatten',
    label: 'Flatten',
    description: 'Expand a JSON/array column into rows',
    icon: Braces,
    category: 'transform_advanced',
    color: 'text-yellow-600',
    bgColor: 'bg-yellow-50 dark:bg-yellow-900/20',
    ...
    minInputs: 1,
    maxInputs: 1,
    tooltip: 'Use FLATTEN to expand a VARIANT, ARRAY or OBJECT column into one row per element',
  },
  {
    id: 'qualify',
    type: 'qualify',
    label: 'Qualify',
    description: 'Filter rows by a window-function expression',
    icon: Filter,
    category: 'transform_advanced',
    color: 'text-orange-600',
    bgColor: 'bg-orange-50 dark:bg-orange-900/20',
    ...
    minInputs: 1,
    maxInputs: 1,
    tooltip: 'Filter rows using a QUALIFY expression on top of a window function (e.g. ROW_NUMBER() = 1)',
  },
  {
    id: 'rollup_cube',
    type: 'rollup_cube',
    label: 'Rollup / Cube',
    description: 'Multi-level GROUP BY with ROLLUP, CUBE or GROUPING SETS',
    icon: Sigma,
    category: 'transform_advanced',
    color: 'text-violet-600',
    bgColor: 'bg-violet-50 dark:bg-violet-900/20',
    ...
    minInputs: 1,
    maxInputs: 1,
    tooltip: 'Compute sub-totals and grand totals using GROUP BY ROLLUP / CUBE / GROUPING SETS',
  },
  {
    id: 'match_recognize',
    type: 'match_recognize',
    label: 'Match Recognize',
    description: 'Row-pattern matching over an ordered partition',
    icon: Search,
    category: 'transform_advanced',
    color: 'text-fuchsia-600',
    bgColor: 'bg-fuchsia-50 dark:bg-fuchsia-900/20',
    ...
    minInputs: 1,
    maxInputs: 1,
    tooltip: 'Detect sequential patterns in ordered rows using MATCH_RECOGNIZE (sessionization, funnels, anomalies)',
  },
  {
    id: 'task_dag',
    type: 'task_dag',
  ...
  // ============================================
  // ADDITIONAL DESTINATION BLOCKS (catalog coherence pass)
  // ============================================
  {
    id: 'copy_into',
    type: 'copy_into',
  ...
  // ============================================
  // ADDITIONAL PYTHON / INFRASTRUCTURE BLOCKS (catalog coherence pass)
  // ============================================
  {
    id: 'compute_pool',
    type: 'compute_pool',
    label: 'Compute Pool',
    description: 'Provision a Snowpark Container Services pool',
    icon: Server,
    category: 'python',
    color: 'text-slate-600',
    bgColor: 'bg-slate-50 dark:bg-slate-900/20',
    ...
    minInputs: 0,
    maxInputs: 0,
    tooltip: 'Create or update a Snowpark Container Services compute pool (instance family, min/max nodes) used by downstream container services',
  },
  {
    id: 'container_service',
    type: 'container_service',
    label: 'Container Service',
    description: 'Run a container image as a Snowpark service',
    icon: Box,
    category: 'python',
    color: 'text-zinc-600',
    bgColor: 'bg-zinc-50 dark:bg-zinc-900/20',
    ...
    minInputs: 0,
    maxInputs: 0,
    tooltip: 'Deploy a container image to a Snowpark Container Services compute pool and optionally expose an endpoint',
  },

  // ============================================
  // ADDITIONAL ML TRAINING BLOCKS (catalog coherence pass)
  // ============================================
  {
    id: 'ml_forecast',
    type: 'ml_forecast',
  ...
  // ============================================
  // ADDITIONAL AI FUNCTION BLOCKS (catalog coherence pass)
  // ============================================
  {
    id: 'ai_embed',
    type: 'ai_embed',
    label: 'AI Embed',
    description: 'EMBED_TEXT — generate vector embeddings',
    icon: Sigma,
    category: 'ai_functions',
    bgColor: 'bg-purple-100 dark:bg-purple-900/30',
    color: 'text-purple-600 dark:text-purple-400',
  ...
  },
  {
    ...
    type: 'ai_redact',
    label: 'AI Redact',
    description: 'Mask PII / PHI / sensitive entities in text',
    icon: EyeOff,
    category: 'ai_functions',
    bgColor: 'bg-purple-100 dark:bg-purple-900/30',
    color: 'text-purple-600 dark:text-purple-400',
  ...
  {
    id: 'ai_count_tokens',
    type: 'ai_count_tokens',
    label: 'AI Count Tokens',
    description: 'Count tokens for a target model',
    icon: Hash,
    category: 'ai_functions',
    bgColor: 'bg-purple-100 dark:bg-purple-900/30',
    color: 'text-purple-600 dark:text-purple-400',
  ...
  },
  {
    ...
    type: 'ai_parse_document',
    label: 'AI Parse Document',
    description: 'PARSE_DOCUMENT — OCR / layout extraction',
    icon: FileText,
    category: 'ai_functions',
    bgColor: 'bg-purple-100 dark:bg-purple-900/30',
    color: 'text-purple-600 dark:text-purple-400',
...
export const LEGACY_TYPE_MAP: Record<string, string> = {
  ...
  // Note: `copy_into` and `merge` are now first-class block types in
  // ETL_BLOCKS — do NOT remap them here or save/reload would rewrite them
  // to `destination` and silently change the block.
};
