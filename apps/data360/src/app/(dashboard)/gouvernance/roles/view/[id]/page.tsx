...
import { getRoleDetails } from '@/app/services/gouvernance/fetch_roles';
import { getRolesForGrantsMatrix } from '@/app/services/gouvernance/fetch_grants';
...
export default function ViewRolePage() {
  ...
  const handleEdit = () => {
    router.push(`/gouvernance/roles/edit/${roleId}`);
  };
