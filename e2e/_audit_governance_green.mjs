...
await page.goto(`${BASE}/governance/policies`, { waitUntil: 'networkidle', timeout: 90000 }).catch((e) => errs.push('goto: ' + e.message));
await page.waitForTimeout(6000);
await page.screenshot({ path: 'docs/product-readiness-audit/screens/module-green/governance.png', fullPage: true });
