        ...
        <div className="p-3 @xl:p-4 @2xl:p-5 xl:col-span-7">
          ...
          <div className="grid grid-cols-8">
            ...
            <div className="relative z-10 col-span-1 mt-1.5">
              <Text
                as="span"
                className="relative -bottom-[38px] block h-3 w-3 rounded-full bg-gray-900 before:absolute before:-left-1.5 before:-top-1.5 before:-z-10 before:h-6 before:w-6 before:rounded-full before:bg-gray-0 dark:bg-gray-900 dark:before:bg-gray-50 lg:-bottom-[22px]"
              ></Text>
              <Text
                as="span"
